...
var _streaming_request = require("./streaming_request.js");

var _streaming_request2 = _interopRequireDefault(_streaming_request);
...
var AppbaseClient = function () {
	...
	_createClass(AppbaseClient, [{
		...
		value: function performStreamingRequest(args) {
			return new _streaming_request2.default(this, JSON.parse(JSON.stringify(args)));
		}
	}, {
		key: "index",
